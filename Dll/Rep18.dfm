object Report18Form: TReport18Form
  Left = 206
  Top = 206
  Width = 707
  Height = 626
  ...
  object MainQuery: TQuery
    ...
    SQL.Strings = (
      'Select *'
        ...
        'From REPORT_18_PROCEDURE(:stat, :id_cst, :id_pdr, :code_pdr, :be' +
        'g_date, :end_date, :tax)'
      '')
    Left = 664
    Top = 128
  ...
  object ActTrQuery: TQuery
    ...
    SQL.Strings = (
      'Select *'
        ...
        'From REPORT_18_PROCEDURE_ACT(:NAME_CST, :ID_PDR, :CODE_PDR, :BEG' +
        '_DATE, :END_DATE, :TAX)')
    Left = 608
    Top = 296
    ParamData = <
  ...
  object NaklQuery: TQuery
    ...
    SQL.Strings = (
      'Select *'
        ...
        'From REPORT_18_PROCEDURE_NAKL(:NAME_CST, :ID_PDR, :CODE_PDR, :BE' +
        'G_DATE, :END_DATE, :TAX)')
    Left = 640
    Top = 296
    ParamData = <
