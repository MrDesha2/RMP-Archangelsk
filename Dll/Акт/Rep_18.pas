...
//       begin
             ...
             If (PdrStringGrid.Cells[0,1] <> '') Then sstr := CentrLine('По выполненным работам (услугам) по '
                + Trim(PdrStringGrid.Cells[0,l]) + ' в руб.',k)
              else
...
//                         h := h +1;
               ...
               begin
                 ...
                 begin
                   If (PdrStringGrid.Cells[1,l] <> '1696') Then
                   begin
                     MainQuery.ParamByName('id_pdr').AsInteger:=StrToInt(PdrStringGrid.Cells[1,l]);
                     MainQuery.ParamByName('code_pdr').AsString:=''
                   end
                    else
                    begin
                      MainQuery.ParamByName('id_pdr').AsInteger:=0;
                      MainQuery.ParamByName('code_pdr').AsString:='30-20%';
                    end
                 end
                  else
                  begin
               ...
               begin
                 ...
                 begin
                    ...
                    RSMtrQuery.ParamByName('id_pdr').AsInteger:=StrToInt(PdrStringGrid.Cells[1,l]);
                 end
                  else
               ...
               If (PdrStringGrid.Cells[0,l]<>'')  Then
               begin
                 If (PdrStringGrid.Cells[1,l] <> '1696') Then
                 begin
                   NaklQuery.ParamByName('id_pdr').AsInteger := StrToInt(PdrStringGrid.Cells[1,l]);
               ...
               begin
                 If (PdrStringGrid.Cells[1,l] <> '1696') Then
                 begin
                   ActTrQuery.ParamByName('id_pdr').AsInteger := StrToInt(PdrStringGrid.Cells[1,l]);
         ...
         begin
            ...
            If (PdrStringGrid.Cells[1,n] <> '30-20') Then
                StrPdr:=StrPdr + PdrStringGrid.Cells[1,n]
                 ...
                 StrPdr:=StrPdr + '4802, 4803, 4804, 4805 ';
         end;
