object DOCT_OPERForm: TDOCT_OPERForm
  ...
  object PageControl: TPageControl
    ...
    object TabSheet_Oper: TTabSheet
      ...
      object PanelFact: TPanel
        ...
        object LabelOper: TLabel
          ...
          Width = 117
          Height = 13
          Caption = #1055#1088#1077#1076#1099#1076#1091#1097#1072#1103' '#1086#1087#1077#1088#1072#1094#1080#1103
          Font.Charset = DEFAULT_CHARSET
          Font.Color = clGray
          Font.Height = -12
          Font.Name = 'MS Sans Serif'
    ...
    object TabSheet_Transport: TTabSheet
      ...
      object ToolBar2: TToolBar
        ...
        Images = DATA.EditImages
        TabOrder = 0
        object ToolButtonAddTransport: TToolButton
          Left = 0
          Top = 0
          Caption = 'ButtonAddFactMt'
          ImageIndex = 0
          OnClick = ToolButtonAddTRANSPORTClick
        end
        object ToolButtonEditTransport: TToolButton
          Left = 23
          Top = 0
          Caption = 'ButtonEditFactMt'
          ImageIndex = 1
          OnClick = ToolButtonEditTRANSPORTClick
        end
        object ToolButtonDelTransport: TToolButton
          Left = 46
          Top = 0
          Caption = 'ButtonDelFactMt'
          ImageIndex = 2
          OnClick = ToolButtonDelTRANSPORTClick
        end
        ...
        object ButtonDownFactTransport: TToolButton
          ...
          Caption = 'ButtonDownFactMt'
          ImageIndex = 4
          OnClick = ToolButtonDownFactTRASNPORTClick
        end
      end
      object GridFactTransport: TStringGrid
        Left = 0
        Top = 25
        Width = 537
        Height = 336
        ...
        Options = [goFixedVertLine, goFixedHorzLine, goVertLine, goHorzLine, goRangeSelect, goColSizing, goRowSelect]
        TabOrder = 1
        OnDblClick = ToolButtonEditTRANSPORTClick
        OnKeyDown = GridFactTransportKeyDown
        ColWidths = (
          15
          50
          313
