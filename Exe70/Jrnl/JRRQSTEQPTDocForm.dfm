object JR_RQSTEQPTForm: TJR_RQSTEQPTForm
  Left = 302
  Top = 319
  Width = 767
  Height = 475
  HelpContext = 330
  Caption = #1046#1091#1088#1085#1072#1083' '#1091#1095#1077#1090#1072' '#1079#1072#1103#1074#1086#1082' '#1087#1086' '#1080#1085#1089#1090#1088#1091#1084#1077#1085#1090#1091
  Color = clBtnFace
  ...
  object FormOrderSource: TDataSource
    DataSet = DATA.qJRRQSTEQPTQuery
    Left = 672
    Top = 33
  end
  object Stored_Del_Proc: TStoredProc
    DatabaseName = 'RMP'
    StoredProcName = 'DEL_RQST_EQPT_PROC'
    Left = 704
    Top = 65
    ParamData = <
      item
