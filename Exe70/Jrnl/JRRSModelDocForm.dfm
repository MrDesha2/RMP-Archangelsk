object JR_RSModelForm: TJR_RSModelForm
  Left = 228
  Top = 185
  Width = 767
  Height = 475
  HelpContext = 330
  Caption = #1046#1091#1088#1085#1072#1083' '#1074#1099#1073#1099#1090#1080#1103' '#1084#1086#1076#1077#1083#1077#1081
  Color = clBtnFace
  ...
  object FormOrderSource: TDataSource
    DataSet = DATA.JRRSMODELFORMQuery
    Left = 672
    Top = 33
  end
  object Stored_Del_Proc: TStoredProc
    DatabaseName = 'RMP'
    StoredProcName = 'DEL_RS_MODEL_PROC'
    Left = 704
    Top = 65
    ParamData = <
      item
