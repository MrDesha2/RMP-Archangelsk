  ...
  object PageControl: TPageControl
    ...
    object TabSheet1: TTabSheet
      ...
      object GroupBox3: TGroupBox
        ...
        Width = 472
        Height = 193
        Caption = #1055#1072#1088#1072#1084#1077#1090#1088#1099' '#1101#1083#1077#1082#1090#1088#1086#1085#1085#1086#1081' '#1087#1086#1095#1090#1099
        TabOrder = 3
        ...
        object EditPOST_USERNAME: TEdit
          Left = 144
          Top = 88
          Width = 321
          Height = 21
          Hint = 
            #1048#1085#1092#1086#1088#1084#1072#1094#1080#1103' '#1086' '#1087#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1077' '#1086#1090#1087#1088#1072#1074#1083#1103#1102#1097#1077#1084' '#1087#1086#1095#1090#1091' ('#1086#1073#1099#1095#1085#1086' '#1092#1086#1088#1084#1080#1088#1091#1077#1090#1089#1103 +
            ' '#1085#1072' '#1088#1091#1089#1089#1082#1086#1084' '#1103#1079#1099#1082#1077' '#1060'.'#1048'.'#1054'.)'
          MaxLength = 60
          ParentShowHint = False
          ShowHint = True
          TabOrder = 2
          OnChange = EditPOST_USERNAMEChange
        end
        object EditPOST_PASSWORD: TEdit
          Left = 144
          Top = 120
          Width = 321
          Height = 21
          Hint = #1055#1072#1088#1086#1083#1100' '#1087#1086#1083#1100#1079#1086#1074#1072#1090#1077#1083#1103' '#1082' '#1077#1075#1086' '#1087#1086#1095#1090#1086#1074#1086#1084#1091' '#1089#1077#1088#1074#1077#1088#1091
          MaxLength = 20
          ParentShowHint = False
          PasswordChar = '*'
          ShowHint = True
          TabOrder = 3
          OnChange = EditPOST_PASSWORDChange
        end
        object EditADRESS_FROM: TEdit
          Left = 144
          Top = 152
          Width = 321
          Height = 21
          Hint = #1040#1076#1088#1077#1089' '#1086#1090#1087#1088#1072#1074#1080#1090#1077#1083#1103' '#1087#1086#1095#1090#1099'  '#1089' '#1082#1086#1090#1086#1088#1086#1075#1086' '#1087#1088#1086#1080#1089#1093#1086#1076#1080#1090' '#1086#1090#1087#1088#1072#1074#1082#1072' '#1087#1086#1095#1090#1099
          MaxLength = 60
          ParentShowHint = False
          ShowHint = True
          TabOrder = 4
          OnChange = EditADRESS_FROMChange
        end
      end
    end
    object TabSheet2: TTabSheet
      ...
      object GroupBox2: TGroupBox
        ...
        object EditOKYD: TEdit
          Left = 140
          Top = 132
          Width = 220
          Height = 21
          TabOrder = 5
          OnChange = EditOKYDChange
        end
    ...
    object TabSheet3: TTabSheet
      ...
      object WorkDateTimeBeg: TDateTimePicker
        ...
        Kind = dtkTime
        TabOrder = 0
        OnChange = WorkDateTimeBegChange
      end
      object WorkDateTimeEnd: TDateTimePicker
        ...
        Kind = dtkTime
        TabOrder = 1
        OnChange = WorkDateTimeEndChange
      end
      object DinnerDateTimeFrom: TDateTimePicker
        ...
        Kind = dtkTime
        TabOrder = 2
        OnChange = DinnerDateTimeFromChange
      end
      object DinnerDateTimeTo: TDateTimePicker
        ...
        Kind = dtkTime
        TabOrder = 3
        OnChange = DinnerDateTimeToChange
      end
    end
  end
